...
class player(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        self.images.append(load_img('parado.png'))
        self.images.append(load_img('passo2.png'))
        self.images.append(load_img('passo3.png'))
        self.images.append(load_img('passo4.png'))
        self.images.append(load_img('passo5.png'))
    ...
    def draw(self,screen):
        ...
        if self.dead == 3:
            ...
            if self.flip_sprite:
                screen.blit(pg.transform.flip(self.images[7],True,False),(self.x,self.y))
            else:
                screen.blit(self.images[7],(self.x,self.y))
        elif self.dead == 5:
            if self.flip_sprite:
                screen.blit(pg.transform.flip(self.images[8],True,False),(self.x,self.y))
            else:
                screen.blit(self.images[8],(self.x,self.y))
        else:
            if self.flip_sprite:
                if self.climb:
                    screen.blit(pg.transform.flip(self.images[5],True,False),(self.x,self.y))
                elif self.lying:
                    screen.blit(pg.transform.flip(self.images[9],True,False),(self.x,self.y))
                else:
                ...
                if self.climb:
                    ...
                    screen.blit(self.images[9],(self.x,self.y))
                else:
        ...
        if self.speed != 0:
            if self.cont >= fps//4:    
                if self.iindex == 4:
                    ...
                    self.image = self.images[self.iindex]
                    self.iindex+=1
                self.cont=0
            self.cont +=1
        else:
